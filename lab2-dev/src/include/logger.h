...
/*!
    It intializes logger data (path to directory with log files). So you could init logger only when no one session is openned
    \param[in] path Path to directory with log files
...
/*!
    this reduced variant of logmsg used in course OOS
    It log message(format string with variadic list of arguments) into log file.
    It requires openned session.
    \param[in] lvl Level of sended log
    \param[in] part Part of the log (needed for custom log reports)
